...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { b_body: @banner.b_body, b_title: @banner.b_title } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { b_body: @banner.b_body, b_title: @banner.b_title } }
